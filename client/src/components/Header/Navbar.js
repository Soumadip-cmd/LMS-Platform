...
const Navbar = () => {
  ...
  const [secondaryDropdown, setSecondaryDropdown] = useState(null);
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-[80] w-full">
        ...
        <nav className="bg-white shadow px-4 lg:px-6 xl:px-14 py-3 flex flex-wrap items-center justify-between relative z-10">
          <div className="flex items-center flex-1 min-w-0">
            <Link to="/" className="flex items-center mr-4 md:mr-6 group flex-shrink-0">
              <img 
            ...
            <div className="relative mx-2 md:mx-4 hidden md:block flex-1 max-w-xs lg:max-w-md xl:max-w-lg">
              <input
                type="text"
                placeholder="Search..."
          ...
          <button
            className="xl:hidden flex items-center justify-center w-10 h-10 text-gray-700 hover:text-blue-600 focus:outline-none transition-colors duration-300 z-[85] flex-shrink-0"
      ...
      <MobileNav 
        ...
        menuItems={menuItems} 
        navigate={navigate} 
        handleDropdownItemNavigation={handleDropdownItemNavigation} 
      />
