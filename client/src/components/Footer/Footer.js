          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-x-12 gap-y-10">
            ...
            <div className="md:col-span-3 space-y-6">
              <div className="flex items-center">
                <div className="bg-yellow-400 w-10 h-10 flex items-center justify-center rounded-md">
                  <span className="font-bold text-sm text-black">PL</span>
                </div>
                <span className="ml-2 font-bold text-blue-700">PREPLINGS</span>
              </div>
              ...
              <p className="text-xs text-gray-500 pt-6 hidden md:block">© 2025 Preplings. All Rights Reserved</p>
            </div>
            ...
            <div className="md:col-span-2 md:ml-6">
              ...
              <ul className="flex flex-wrap gap-x-4 gap-y-2 md:block md:space-y-3 text-sm text-gray-600">
                ...
                <li><a href="#" className="hover:text-blue-700">Instructor</a></li>
                <li><a href="#" className="hover:text-blue-700">Events</a></li>
                <li><a href="#" className="hover:text-blue-700">Become an Instructor</a></li>
              </ul>
            </div>
            ...
            <div className="hidden md:block md:col-span-2">
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                <li><a href="#" className="hover:text-blue-700">News & Blog</a></li>
                <li><a href="#" className="hover:text-blue-700">Library</a></li>
            ...
            <div className="md:col-span-5">
              <h3 className="font-medium mb-3 text-gray-800">Sign Up for Our Newsletter</h3>
              <p className="text-sm text-gray-600 mb-5">Receive weekly newsletter with educational materials, popular books and much more!</p>
              ...
              <p className="text-xs text-center md:hidden text-gray-500 mt-6">© 2025 Preplings. All Rights Reserved</p>
            </div>
          </div>
        </div>
      </div>
