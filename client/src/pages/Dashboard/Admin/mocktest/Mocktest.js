...
const MockTests = () => {
  ...
  return (
    <div className="flex">
      <AdminSidebar active="Mock Tests" />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6">
            <div>
              ...
              <p className="text-gray-400 text-base">
                Manage practice exams and student performance
              </p>
            </div>
          ...
          <div className="bg-gray-50 rounded-3xl p-4 mb-4 lg:mb-6">
            <div className="flex flex-col lg:flex-row gap-5">
              <div className="relative flex-grow">
                ...
                <input
                  type="text"
                  placeholder="Search by exam ID, Instructor, or language..."
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="text-gray-500 text-sm">
                    <th className="pb-3 px-4 font-medium text-left">Test ID</th>
                    <th className="pb-3 px-4 font-medium text-left">Test Name</th>
                    <th className="pb-3 px-4 font-medium text-left">Instructor</th>
                    <th className="pb-3 px-4 font-medium text-left">Exam Type</th>
                ...
                <tbody>
                  {tests.map((test, index) => (
                    <>
                      ...
                      <td className="py-3 px-4 whitespace-nowrap">
                        <span
                          className={`inline-block text-center px-4 py-1 rounded-md text-sm font-medium cursor-pointer ${getStatusClass(
                            test.status
                          )}`}
                        >
                          {test.status}
